...
enum Router{
    ...
    var headers:HTTPHeaders{
        ...
        case .signUp, .login, .getAllPlaces, .getAllGalleryByPlaceID, .getAPlaceById, .getPopularPlacesWithLimit, .getLastPlacesWithLimit, .getPopularPlaces, .getLastPlaces:
            return [:]
        case .postAVisit, .deleteAVisit, .editProfile, .getPersonalInfo, .getAllPlacesForUser, .checkVisitByPlaceId, .postAPlace, .postAGalleryImage, .getUserProfile, .changePassword:
